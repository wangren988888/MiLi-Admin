...
import {
    ...
    restoreTrash,
    messageCount,
    getEssayClassifyList,
    getEssayListForClassifyId
} from './user'
...
Mock.mock(/\essay\/getEssayClassifyList/, getEssayClassifyList)
Mock.mock(/\essay\/getEssayListForClassifyId/, getEssayListForClassifyId)
